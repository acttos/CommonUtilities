#
#  Be sure to run `pod spec lint CUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "acttos"
  # s.authors            = { "acttos" => "majinshou@gmail.com" }
  # s.social_media_url   = "http://twitter.com/acttos"
  ...
  s.source       = { :git => "https://github.com/acttos/CommonUtilities.git", :tag => "0.0.5" }
